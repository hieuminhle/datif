...
# MAGIC - 13.11.2024 Sebastian Fastert: Strategische Themen hinzugefügt
...
df_facebook_total = spark.sql(f"""
                                SELECT 
                                    ...
                                    CASE 
                                        WHEN GREATEST(Strategie2030, FinanzierungEnergiewende, EMobilitaet, Performancekultur, VernetzeEnergiewelt, TransformationGasnetzeWasserstoff, ErneuerbareEnergien, DisponibleErzeugung, IntelligenteStromnetze, EnBWAlsArbeitgeberIn, NachhaltigkeitCSRESG, MarkeEnBW) >= 0.8 THEN 
                                            CASE 
                                                WHEN Strategie2030 >= GREATEST(Strategie2030, FinanzierungEnergiewende, EMobilitaet, Performancekultur, VernetzeEnergiewelt, TransformationGasnetzeWasserstoff, ErneuerbareEnergien, DisponibleErzeugung, IntelligenteStromnetze, EnBWAlsArbeitgeberIn, NachhaltigkeitCSRESG, MarkeEnBW) THEN 'Strategie2030'
                                                WHEN FinanzierungEnergiewende >= GREATEST(Strategie2030, FinanzierungEnergiewende, EMobilitaet, Performancekultur, VernetzeEnergiewelt, TransformationGasnetzeWasserstoff, ErneuerbareEnergien, DisponibleErzeugung, IntelligenteStromnetze, EnBWAlsArbeitgeberIn, NachhaltigkeitCSRESG, MarkeEnBW) THEN 'FinanzierungEnergiewende'
                                                WHEN EMobilitaet >= GREATEST(Strategie2030, FinanzierungEnergiewende, EMobilitaet, Performancekultur, VernetzeEnergiewelt, TransformationGasnetzeWasserstoff, ErneuerbareEnergien, DisponibleErzeugung, IntelligenteStromnetze, EnBWAlsArbeitgeberIn, NachhaltigkeitCSRESG, MarkeEnBW) THEN 'EMobilitaet'
                                                WHEN Performancekultur >= GREATEST(Strategie2030, FinanzierungEnergiewende, EMobilitaet, Performancekultur, VernetzeEnergiewelt, TransformationGasnetzeWasserstoff, ErneuerbareEnergien, DisponibleErzeugung, IntelligenteStromnetze, EnBWAlsArbeitgeberIn, NachhaltigkeitCSRESG, MarkeEnBW) THEN 'Performancekultur'
                                                WHEN VernetzeEnergiewelt >= GREATEST(Strategie2030, FinanzierungEnergiewende, EMobilitaet, Performancekultur, VernetzeEnergiewelt, TransformationGasnetzeWasserstoff, ErneuerbareEnergien, DisponibleErzeugung, IntelligenteStromnetze, EnBWAlsArbeitgeberIn, NachhaltigkeitCSRESG, MarkeEnBW) THEN 'VernetzeEnergiewelt'
                                                WHEN TransformationGasnetzeWasserstoff >= GREATEST(Strategie2030, FinanzierungEnergiewende, EMobilitaet, Performancekultur, VernetzeEnergiewelt, TransformationGasnetzeWasserstoff, ErneuerbareEnergien, DisponibleErzeugung, IntelligenteStromnetze, EnBWAlsArbeitgeberIn, NachhaltigkeitCSRESG, MarkeEnBW) THEN 'TransformationGasnetzeWasserstoff'
                                                WHEN ErneuerbareEnergien >= GREATEST(Strategie2030, FinanzierungEnergiewende, EMobilitaet, Performancekultur, VernetzeEnergiewelt, TransformationGasnetzeWasserstoff, ErneuerbareEnergien, DisponibleErzeugung, IntelligenteStromnetze, EnBWAlsArbeitgeberIn, NachhaltigkeitCSRESG, MarkeEnBW) THEN 'ErneuerbareEnergien'
                                                WHEN DisponibleErzeugung >= GREATEST(Strategie2030, FinanzierungEnergiewende, EMobilitaet, Performancekultur, VernetzeEnergiewelt, TransformationGasnetzeWasserstoff, ErneuerbareEnergien, DisponibleErzeugung, IntelligenteStromnetze, EnBWAlsArbeitgeberIn, NachhaltigkeitCSRESG, MarkeEnBW) THEN 'DisponibleErzeugung'
                                                WHEN IntelligenteStromnetze >= GREATEST(Strategie2030, FinanzierungEnergiewende, EMobilitaet, Performancekultur, VernetzeEnergiewelt, TransformationGasnetzeWasserstoff, ErneuerbareEnergien, DisponibleErzeugung, IntelligenteStromnetze, EnBWAlsArbeitgeberIn, NachhaltigkeitCSRESG, MarkeEnBW) THEN 'IntelligenteStromnetze'
                                                WHEN EnBWAlsArbeitgeberIn >= GREATEST(Strategie2030, FinanzierungEnergiewende, EMobilitaet, Performancekultur, VernetzeEnergiewelt, TransformationGasnetzeWasserstoff, ErneuerbareEnergien, DisponibleErzeugung, IntelligenteStromnetze, EnBWAlsArbeitgeberIn, NachhaltigkeitCSRESG, MarkeEnBW) THEN 'EnBWAlsArbeitgeberIn'
                                                WHEN NachhaltigkeitCSRESG >= GREATEST(Strategie2030, FinanzierungEnergiewende, EMobilitaet, Performancekultur, VernetzeEnergiewelt, TransformationGasnetzeWasserstoff, ErneuerbareEnergien, DisponibleErzeugung, IntelligenteStromnetze, EnBWAlsArbeitgeberIn, NachhaltigkeitCSRESG, MarkeEnBW) THEN 'NachhaltigkeitCSRESG'
                                                WHEN MarkeEnBW >= GREATEST(Strategie2030, FinanzierungEnergiewende, EMobilitaet, Performancekultur, VernetzeEnergiewelt, TransformationGasnetzeWasserstoff, ErneuerbareEnergien, DisponibleErzeugung, IntelligenteStromnetze, EnBWAlsArbeitgeberIn, NachhaltigkeitCSRESG, MarkeEnBW) THEN 'MarkeEnBW'
                                            END
